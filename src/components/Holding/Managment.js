			...
			<div style={{ marginBottom: '200px',width:'100%' }}>
				...
				<Grid style={{width:'100%'}}>
					<GridRow centered>
						...
						<GridColumn computer={4} mobile={10}>
							<Image style={{ width: '240px',margin:'0 auto' }} src={david} circular />
							<h3>Tobias Reiter, MSc.</h3>
							<h4>Founder and Director of Corporate Development</h4>
						...
						<GridColumn computer={4} mobile={10}>
							<Image style={{ width: '240px',margin:'0 auto' }} src={david} circular />
							<h3>Gabriel Nguyen</h3>
							<h4>Founder and Chief Financial Officer</h4>
					...
					<GridRow centered>
						...
						<GridColumn computer={4} mobile={10}>
							<Image style={{ width: '240px',margin:'0 auto' }} src={david} circular />
							<h3>Ernest Kayinamura, MSc.</h3>
							<h4>Director of Corporate Development, Africa</h4>

...
const Mission = () =>
	(
		<div style={{ position: 'relative', background: 'white', width: '100%', paddingTop: '40px' }}>
			<div>
				<h2 className='h2Afr' style={{ textAlign: 'center' }}>Mission <span style={{ color: '#003571' }}>statement</span></h2>
			...
			<Grid style={{ margin: '0px', background: 'white' }}>
				<GridRow style={{ background: 'white', paddingTop: '80px' }} centered>
					<GridColumn style={{ background: 'white' }} className='flatDiv' textAlign='center' computer={12} tablet={14} mobile={15}>

				...
				<div className='navbarDiv'>
					...
					<div className='menuStandard' style={{ marginLeft: 'auto', paddingRight: '50px' }}>
						<Menu className='menuItem' stackable pointing secondary size='large' style={{ borderBottom: 'none' }}>
							...
							<Link to='/reves_holdings_africa'><Menu.Item className={this.state.class} name='Reves_holdings_africa' active={activeItem === 'Reves_holdings_africa'} onClick={this.border}>Reves Holding Africa</Menu.Item></Link>
